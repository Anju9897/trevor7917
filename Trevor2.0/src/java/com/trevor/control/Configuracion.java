        ...
        if (accion == null) {
            ...
            try {
                ...
                if (request.getParameter("txtBusqueda") != null) {
                    sql = "select idUsuario,Nombres,Apellidos,email,telefono,idrol from Usuario where Nombre like ?";
                } else {
                    sql = "select idUsuario,Nombres,Apellidos,email,telefono,idrol from Usuario";
                }
                String[][] usuario = null;
                if (request.getParameter("txtBusqueda") != null) {
