...
public class Tabla {
    ...
    public void setPageContext(String contextPath){
        ...
        while (k<rst[0].length){             
            ...
            for (int i=0;i<numeroColumnas;i++){                 
                 if (getColumnasSeleccionables()==null)
                    ...
                    if (found)
                        Tabla +="<td><a href='"+getPageContext()+getPaginaSeleccionable()+(getPaginaEliminable().contains("?") ? "&" : "?")+"id="+rst[0][k]+"'>"
                            + rst[i][k]+"</a></td>";
                    else
                        Tabla +="<td>"+ rst[i][k]+"</td>";
                 }
           ...
           if (isEliminable()){
                ...
                if (getIconoEliminable().equals(""))
                    ...
                    enlaceEliminable = "<img src='"+getIconoEliminable()+"'/>";               
                Tabla +="<td>"
                        + "<a href='"+getPageContext()+getPaginaEliminable()+ (getPaginaEliminable().contains("?") ? "&" : "?") +"id="+rst[0][k]+"'>"
           ...
           if (isModificable()){
                ...
                if (getIconoModificable().equals(""))
                    ...
                    enlaceModificable = "<img src='"+getIconoModificable()+"'/>";
                 
                Tabla +="<td><a href='"+getPageContext()+getPaginaModificable()+ (getPaginaModificable().contains("?") ? "&" : "?") +"id="+rst[0][k]+"'>"+enlaceModificable+"</a></td>"; 
           }
           if (isSeleccionable()){
                ...
                Tabla +="<td><a href='"+getPageContext()+getPaginaSeleccionable()+ (getPaginaSeleccionable().contains("?") ? "&" : "?") +"id="+rst[0][k]+"'>"+enlaceSeleccionable+"</a></td>"; 
           }
