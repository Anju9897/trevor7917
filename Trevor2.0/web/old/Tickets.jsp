<%-- 
    Document   : Tickets
    Created on : 10-16-2019, 03:59:06 PM
    Author     : Georgina
--%>
        ...
        <div class="contenedor row">
            ...
            <div class="col-r2">
                ...
                <div class="info hide "   id="info">
                    ...
                    <div class="col-8 mens "style="margin-left: 20px">
                        <div class="col-1">
                    ...
                    <div   class="col-4  tik" id="tipo">
                        ...
                        <select>
                            ...
                            <option value="3">Solicitud de funcion</option>
                        ...
                        <select>
                            ...
                            <option value="5">Espera de cliente</option>
                            <option value="6">Espera de tercero</option>
                        ...
                        <br>
                        <select>
                            <option value="1">Juan Jose Ramos Garcia</option>
                            <option value="2">Marina Claribel Guardado Monge</option>
                            <option value="3">Xenia Mariel Castillo</option>
                            <option value="4">Georgina Larissa Granados Garcia</option>
